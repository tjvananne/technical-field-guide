...
#' 
#' 
#' Eventually I'd like to rework this to be numeric values. That would open us up to more
#' mutation possibilities. But for now, the bits are pretty cool because they act more
#' like "genes"
#' 
